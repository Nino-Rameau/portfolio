  ...
  return (
    <>
      <SEO
        ...
        canonical="https://nino-rameau.fr/mentionsLegales"
      />

      <div className="m-10">
        <Texte tag="h1" balise="h1" texte="Mentions Légales" />

        <Texte tag="h2" balise="h2" marge="s" texte="1. Informations générales" className="pt-6 text-left" />
        ...
        <Texte tag="h2" balise="h2" marge="s" texte="2. Propriété intellectuelle" className="pt-6 text-left" />
        ...
        <Texte tag="h2" balise="h2" marge="s" texte="3. Responsabilité" className="pt-6 text-left" />
        ...
        <Texte tag="h2" balise="h2" marge="s" texte="4. Liens hypertextes" className="pt-6 text-left" />
        ...
        <Texte tag="h2" balise="h2" marge="s" texte="5. Données personnelles et cookies" className="pt-6 text-left" />
        ...
        <Texte tag="h2" balise="h2" marge="s" texte="6. Contact" className="pt-6 text-left" />
